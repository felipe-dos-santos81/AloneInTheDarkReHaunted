...
| 2 | Startup menu works by mouse; clicking a portrait picks that character at once; on the story page, ▶ on the last page starts the game and ✕ returns to character select with both portraits drawn (HD and SD) | | |
